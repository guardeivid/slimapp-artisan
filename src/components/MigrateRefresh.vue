  ...
  <div class="hello">
    ...
    <div class="row">
      <div class="col-md-6 mb-3">
        ...
        <div v-if="data.seed">
          <div class="form-group">
            <label for="seeder">Nombre de la clase raíz de los Seeder (opcional)</label>
            <select type="text" class="form-control" id="seeder" placeholder="Class Seeder" v-model="data.seeder" @change="command">
              <option></option>
...
export default {
  ...
  methods: {
    command() {
      let cmd = '> php artisan migrate:refresh';
    ...
    submit() {
      this.command();
      this.$parent.send('migrate/refresh', this.data);
    },
  },
};
</script>
